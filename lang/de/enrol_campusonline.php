...
$string['allowemailupdate'] = 'Nutzerdaten Sync darf E-Mail-Adressen zu ändern';
$string['allowemailupdate_desc'] = 'Erlaubt dem Nutzerdaten Sync, die E-Mail-Adressen bestehender Nutzer/innenzu ändern. Beachten Sie, dass dies zu Problemen führen kann, da auf einigen Moodle-Websites Nutzer/innenihre E-Mail-Adresse zum Einloggen verwenden.';
$string['allowusernameupdate'] = 'Nutzerdaten Sync darf Anmeldenamen ändern';
$string['allowusernameupdate_desc'] = 'Erlaubt dem Nutzerdaten Sync, die Anmeldenamen bestehender Nutzer/innenzu ändern. Beachten Sie, dass dies zu Problemen bei der Anmeldung führen kann.';
$string['authmethod'] = 'Authentifizierungsmethode';
$string['autoidnewusers'] = 'Neue Nutzer/innenautomatisch identifizieren';
$string['autoidnewusers_desc'] = 'Identifiziert neu erstellte Nutzer/innenbeim Erstellen. Nützlich, wenn die Nutzer/innendurch SSO angelegt werden.';
...
$string['campusonline:unenrol'] = 'CAMPUSonline enrolments entfernen';
$string['campusonline:config'] = 'CAMPUSonline enrolments konfigurieren';
$string['campusonline:synccourse'] = 'Einen einzelnen Kurs mit CAMPUSonline syncen';
$string['campusonline:syncuser'] = 'Einen einzelnen Nutzer/innenmit CAMPUSonline syncen';
...
$string['enrolsynccreateusers'] = 'Nutzer/innenbeim Kurs-  erstellen';
$string['enrolsynccreateusers_desc'] = 'Erlaubt dem Kurs Sync Tasks, Nutzer/innenzu erstellen. <ul><li>Beachten Sie, dass Nutzer/innennormalerweise durch SSO oder den Nutzerdaten Sync Task angelegt werden!</li>
<li><strong>Aktivieren Sie dies nur, nachdem Sie sichergestellt haben, dass die Benutzeridentifikation korrekt funktioniert, andernfalls könnten viele doppelte Nutzer/innenin Moodle entstehen!</strong></li></ul>';
...
$string['idattempts_desc'] = 'Ein Zähler für die fehlgeschlagenen Versuche einen Nutzer/innenzu identifizieren wird in einem CAMPUSonline Nutzer/innenProfilfeld geführt. Dieser Zähler kann von Admins zurückgesetzt werden, um erneut zu versuchen, den Nutzer/innenin CAMPUSonline zu finden.';
$string['initialpassword'] = 'Initialpasswort für neu erstellte Benutzer';
$string['initialpassword_desc'] = 'Leerlassen, um eine zufällig generiertes Password für neue User zu verwenden (empfohlen). <p> Wenn Sie das Password selbst setzen, stellen Sie sicher, dass Sie ein Initialpasswort festlegen, das den Komplexitätsstandards entspricht, oder die Benutzererstellung schlägt fehl, <strong>selbst für Nutzer/innenmit Authentifizierungsmethoden, die das Passwort nicht verwenden!</strong></p>';
...
$string['previewusers'] = 'Vorschau für Nutzer/innenmit diesen Einstellungen';
...
$string['skippedcourses'] = '{$a} Kurse wurden übersprungen, weil ihre Organisation nicht dem gesetzten Filter (Einstellung orgfilter) entspricht.';
$string['sourceclaim'] = 'CAMPUSonline ID';
$string['sourceclaim_desc'] = 'Wählen Sie die ID, welche die Moodle Nutzer/innengesetzt haben.';
...
$string['syncthisuser'] = 'Synchronisiere Nutzer/innenmit CAMPUSonline';
...
$string['task:user_id'] = 'CAMPUSonline Nutzer/innenIdentifikation';
...
$string['useridsettings_desc'] = '<ul>
    <li>Dieser Sync Task verknüpft bestehende Moodle-Nutzer/innenmit CAMPUSonline Personen. Standardmäßig wird dieser Task nicht geplant ausgeführt, und sollte nur manuell gestartet werden</li>
    ...
    <li>Sobald ein Nutzer/innenin CAMPUSonline gefunden wird, wird das Benutzerprofilfeld <strong>campusonline_person_uid</strong> mit der CAMPUSonline Person UID befüllt (dieses Feld wird bei der Plugin-Installation erstellt)</li></ul>';
$string['usermoodlefield'] = 'Benutzerdefiniertes Feld als Fallback für die Benutzeridentifikation';
$string['usermoodlefield_desc'] = 'Wenn ein Nutzer/innenauf keine andere Weise gefunden wird (siehe oben), wird dieses Feld verwendet, um den Nutzer/innenin Moodle zu finden.';
$string['usersyncsettings'] = 'Nutzerdaten Sync';
$string['usersyncsettings_desc'] = '<ul>
    <li>Nutzer/innenkönnen bei der Anmeldung automatisch gesynct werden, oder manuell über den Link <strong>Diesen Nutzer/innenmit CAMPUSonline syncen</strong> auf der Benutzerprofil Seite.</li>
...
$string['usersyncsingle'] = 'Diesen Nutzer/innenmit CAMPUSonline synchronisieren';
