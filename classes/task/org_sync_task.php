...
/**
 * Moodle page for syncing organisations from CAMPUSonline to Moodle.
 *
...
/**
 * Scheduled task for syncing organizations from CAMPUSonline to Moodle.
 *
 * @package    enrol_campusonline
 * @copyright  2024, TU Graz
 * @author     think-modular (stefan.weber@think-modular.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class org_sync_task extends \core\task\scheduled_task {

    /**
     * Task name.
     */
    public function get_name() {
        return get_string('task:org_sync', 'enrol_campusonline');
    }
